...
func cerbos_request_v1_InspectPoliciesRequest_hashpb_sum(m *InspectPoliciesRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.include_disabled"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetIncludeDisabled())))
	}
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.name_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetNameRegexp()))))
		_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(m.GetNameRegexp()), len(m.GetNameRegexp())))
	}
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.scope_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetScopeRegexp()))))
		_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(m.GetScopeRegexp()), len(m.GetScopeRegexp())))
	}
	if _, ok := ignore["cerbos.request.v1.InspectPoliciesRequest.version_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetVersionRegexp()))))
		_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(m.GetVersionRegexp()), len(m.GetVersionRegexp())))
	}
...
func cerbos_request_v1_ListAuditLogEntriesRequest_TimeRange_hashpb_sum(m *ListAuditLogEntriesRequest_TimeRange, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange.start"]; !ok {
		if m.GetStart() != nil {
			google_protobuf_Timestamp_hashpb_sum(m.GetStart(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.request.v1.ListAuditLogEntriesRequest.TimeRange.end"]; !ok {
		if m.GetEnd() != nil {
			google_protobuf_Timestamp_hashpb_sum(m.GetEnd(), hasher, ignore, b)
		}
	}
}
	...
	if m.Filter != nil {
		if _, ok := ignore["cerbos.request.v1.ListAuditLogEntriesRequest.filter"]; !ok {
			...
			case *ListAuditLogEntriesRequest_Tail:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(t.Tail)))
			case *ListAuditLogEntriesRequest_Between:
				if t.Between != nil {
					cerbos_request_v1_ListAuditLogEntriesRequest_TimeRange_hashpb_sum(t.Between, hasher, ignore, b)
				}
			case *ListAuditLogEntriesRequest_Since:
				if t.Since != nil {
					google_protobuf_Duration_hashpb_sum(t.Since, hasher, ignore, b)
				}
			case *ListAuditLogEntriesRequest_Lookup:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Lookup))))
				_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(t.Lookup), len(t.Lookup)))
			}
		}
	}
}
...
func cerbos_request_v1_PurgeStoreRevisionsRequest_hashpb_sum(m *PurgeStoreRevisionsRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.request.v1.PurgeStoreRevisionsRequest.keep_last"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetKeepLast())))
	}
}
...
func cerbos_request_v1_ReloadStoreRequest_hashpb_sum(m *ReloadStoreRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.request.v1.ReloadStoreRequest.wait"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetWait())))
	}
}
