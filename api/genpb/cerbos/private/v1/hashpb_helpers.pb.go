...
func authzen_authorization_v1_AccessEvaluationBatchRequest_Evaluation_hashpb_sum(m *v1.AccessEvaluationBatchRequest_Evaluation, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationBatchRequest.Evaluation.subject"]; !ok {
		if m.GetSubject() != nil {
			authzen_authorization_v1_Subject_hashpb_sum(m.GetSubject(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationBatchRequest.Evaluation.resource"]; !ok {
		if m.GetResource() != nil {
			authzen_authorization_v1_Resource_hashpb_sum(m.GetResource(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationBatchRequest.Evaluation.action"]; !ok {
		if m.GetAction() != nil {
			authzen_authorization_v1_Action_hashpb_sum(m.GetAction(), hasher, ignore, b)
		}
	}
		...
		if len(m.Context) > 0 {
			if len(m.Context) <= 32 {
				...
				for _, k := range keys {
					...
					if m.Context[k] != nil {
						google_protobuf_Value_hashpb_sum(m.Context[k], hasher, ignore, b)
					}
				}
...
func authzen_authorization_v1_AccessEvaluationBatchRequest_hashpb_sum(m *v1.AccessEvaluationBatchRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationBatchRequest.evaluations"]; !ok {
		if len(m.Evaluations) > 0 {
			for _, v := range m.Evaluations {
				if v != nil {
					authzen_authorization_v1_AccessEvaluationBatchRequest_Evaluation_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationBatchRequest.options"]; !ok {
		if m.GetOptions() != nil {
			authzen_authorization_v1_AccessEvaluationsOptions_hashpb_sum(m.GetOptions(), hasher, ignore, b)
		}
	}
}
...
func authzen_authorization_v1_AccessEvaluationBatchResponse_hashpb_sum(m *v1.AccessEvaluationBatchResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationBatchResponse.evaluations"]; !ok {
		if len(m.Evaluations) > 0 {
			for _, v := range m.Evaluations {
				if v != nil {
					authzen_authorization_v1_AccessEvaluationResponse_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func authzen_authorization_v1_AccessEvaluationResponse_hashpb_sum(m *v1.AccessEvaluationResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationResponse.decision"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetDecision())))
	}
...
func authzen_authorization_v1_AccessEvaluationsOptions_hashpb_sum(m *v1.AccessEvaluationsOptions, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["authzen.authorization.v1.AccessEvaluationsOptions.evaluations_semantic"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetEvaluationsSemantic()))))
			...
			if len(m.Properties) <= 32 {
				...
				for _, k := range keys {
					...
					if m.Properties[k] != nil {
						google_protobuf_Value_hashpb_sum(m.Properties[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_audit_v1_PolicySource_Hub_hashpb_sum(m *v11.PolicySource_Hub, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Source != nil {
		if _, ok := ignore["cerbos.audit.v1.PolicySource.Hub.source"]; !ok {
			...
			case *v11.PolicySource_Hub_Label:
			...
			case *v11.PolicySource_Hub_DeploymentId:
			...
			case *v11.PolicySource_Hub_PlaygroundId:
...
func cerbos_engine_v1_Trace_Component_hashpb_sum(m *v12.Trace_Component, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Details != nil {
		if _, ok := ignore["cerbos.engine.v1.Trace.Component.details"]; !ok {
			...
			case *v12.Trace_Component_Action:
			...
			case *v12.Trace_Component_DerivedRole:
			...
			case *v12.Trace_Component_Index:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(t.Index)))
			case *v12.Trace_Component_Policy:
			...
			case *v12.Trace_Component_Resource:
			...
			case *v12.Trace_Component_Scope:
			...
			case *v12.Trace_Component_RolePolicyScope:
...
func cerbos_policy_v1_Condition_hashpb_sum(m *v13.Condition, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Condition != nil {
		if _, ok := ignore["cerbos.policy.v1.Condition.condition"]; !ok {
			...
			case *v13.Condition_Match:
				if t.Match != nil {
					cerbos_policy_v1_Match_hashpb_sum(t.Match, hasher, ignore, b)
				}
			case *v13.Condition_Script:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Script))))
		...
		if len(m.Local) > 0 {
			if len(m.Local) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Local[k] != nil {
						google_protobuf_Value_hashpb_sum(m.Local[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_policy_v1_DerivedRoles_hashpb_sum(m *v13.DerivedRoles, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.DerivedRoles.definitions"]; !ok {
		if len(m.Definitions) > 0 {
			for _, v := range m.Definitions {
				if v != nil {
					cerbos_policy_v1_RoleDef_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
			...
			if len(m.Definitions) <= 32 {
				...
				for _, k := range keys {
					...
					if m.Definitions[k] != nil {
						google_protobuf_Value_hashpb_sum(m.Definitions[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
		...
		if len(m.Definitions) > 0 {
			if len(m.Definitions) <= 32 {
				...
				for _, k := range keys {
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(k))))
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.Definitions[k]))))
...
func cerbos_policy_v1_Match_ExprList_hashpb_sum(m *v13.Match_ExprList, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.Match.ExprList.of"]; !ok {
		if len(m.Of) > 0 {
			for _, v := range m.Of {
				if v != nil {
					cerbos_policy_v1_Match_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_Match_hashpb_sum(m *v13.Match, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Op != nil {
		if _, ok := ignore["cerbos.policy.v1.Match.op"]; !ok {
			...
			case *v13.Match_All:
				if t.All != nil {
					cerbos_policy_v1_Match_ExprList_hashpb_sum(t.All, hasher, ignore, b)
				}
			case *v13.Match_Any:
				if t.Any != nil {
					cerbos_policy_v1_Match_ExprList_hashpb_sum(t.Any, hasher, ignore, b)
				}
			case *v13.Match_None:
				if t.None != nil {
					cerbos_policy_v1_Match_ExprList_hashpb_sum(t.None, hasher, ignore, b)
				}
			case *v13.Match_Expr:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Expr))))
				_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(t.Expr), len(t.Expr)))
...
func cerbos_policy_v1_Metadata_hashpb_sum(m *v13.Metadata, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.Metadata.source_file"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetSourceFile()))))
	...
	if _, ok := ignore["cerbos.policy.v1.Metadata.hash"]; !ok {
		if m.GetHash() != nil {
			google_protobuf_UInt64Value_hashpb_sum(m.GetHash(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.policy.v1.Metadata.store_identifer"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetStoreIdentifer()))))
	...
	if _, ok := ignore["cerbos.policy.v1.Metadata.store_identifier"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetStoreIdentifier()))))
	...
	if _, ok := ignore["cerbos.policy.v1.Metadata.source_attributes"]; !ok {
		if m.GetSourceAttributes() != nil {
			cerbos_policy_v1_SourceAttributes_hashpb_sum(m.GetSourceAttributes(), hasher, ignore, b)
		}
	}
}
...
func cerbos_policy_v1_Output_When_hashpb_sum(m *v13.Output_When, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.Output.When.rule_activated"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetRuleActivated()))))
	...
	if _, ok := ignore["cerbos.policy.v1.Output.When.condition_not_met"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetConditionNotMet()))))
...
func cerbos_policy_v1_Output_hashpb_sum(m *v13.Output, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.Output.when"]; !ok {
		if m.GetWhen() != nil {
			cerbos_policy_v1_Output_When_hashpb_sum(m.GetWhen(), hasher, ignore, b)
		}
	}
}
...
func cerbos_policy_v1_Policy_hashpb_sum(m *v13.Policy, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.Policy.disabled"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetDisabled())))
	}
	...
	if _, ok := ignore["cerbos.policy.v1.Policy.metadata"]; !ok {
		if m.GetMetadata() != nil {
			cerbos_policy_v1_Metadata_hashpb_sum(m.GetMetadata(), hasher, ignore, b)
		}
	}
	if m.PolicyType != nil {
		if _, ok := ignore["cerbos.policy.v1.Policy.policy_type"]; !ok {
			switch t := m.PolicyType.(type) {
			case *v13.Policy_ResourcePolicy:
				if t.ResourcePolicy != nil {
					cerbos_policy_v1_ResourcePolicy_hashpb_sum(t.ResourcePolicy, hasher, ignore, b)
				}
			case *v13.Policy_PrincipalPolicy:
				if t.PrincipalPolicy != nil {
					cerbos_policy_v1_PrincipalPolicy_hashpb_sum(t.PrincipalPolicy, hasher, ignore, b)
				}
			case *v13.Policy_DerivedRoles:
				if t.DerivedRoles != nil {
					cerbos_policy_v1_DerivedRoles_hashpb_sum(t.DerivedRoles, hasher, ignore, b)
				}
			case *v13.Policy_ExportVariables:
				if t.ExportVariables != nil {
					cerbos_policy_v1_ExportVariables_hashpb_sum(t.ExportVariables, hasher, ignore, b)
				}
			case *v13.Policy_RolePolicy:
				if t.RolePolicy != nil {
					cerbos_policy_v1_RolePolicy_hashpb_sum(t.RolePolicy, hasher, ignore, b)
				}
			case *v13.Policy_ExportConstants:
				if t.ExportConstants != nil {
					cerbos_policy_v1_ExportConstants_hashpb_sum(t.ExportConstants, hasher, ignore, b)
				}
			}
		}
	}
		...
		if len(m.Variables) > 0 {
			if len(m.Variables) <= 32 {
				...
				for _, k := range keys {
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(k))))
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.Variables[k]))))
	...
	if _, ok := ignore["cerbos.policy.v1.Policy.json_schema"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetJsonSchema()))))
	...
	if _, ok := ignore["cerbos.policy.v1.PrincipalPolicy.rules"]; !ok {
		if len(m.Rules) > 0 {
			for _, v := range m.Rules {
				if v != nil {
					cerbos_policy_v1_PrincipalRule_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_PrincipalRule_hashpb_sum(m *v13.PrincipalRule, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.PrincipalRule.actions"]; !ok {
		if len(m.Actions) > 0 {
			for _, v := range m.Actions {
				if v != nil {
					cerbos_policy_v1_PrincipalRule_Action_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_ResourcePolicy_hashpb_sum(m *v13.ResourcePolicy, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.ResourcePolicy.rules"]; !ok {
		if len(m.Rules) > 0 {
			for _, v := range m.Rules {
				if v != nil {
					cerbos_policy_v1_ResourceRule_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_RolePolicy_hashpb_sum(m *v13.RolePolicy, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.RolePolicy.rules"]; !ok {
		if len(m.Rules) > 0 {
			for _, v := range m.Rules {
				if v != nil {
					cerbos_policy_v1_RoleRule_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestResults_Action_hashpb_sum(m *v13.TestResults_Action, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Action.details"]; !ok {
		if m.GetDetails() != nil {
			cerbos_policy_v1_TestResults_Details_hashpb_sum(m.GetDetails(), hasher, ignore, b)
		}
	}
}
...
func cerbos_policy_v1_TestResults_Details_hashpb_sum(m *v13.TestResults_Details, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.policy.v1.TestResults.Details.outcome"]; !ok {
			...
			case *v13.TestResults_Details_Failure:
				if t.Failure != nil {
					cerbos_policy_v1_TestResults_Failure_hashpb_sum(t.Failure, hasher, ignore, b)
				}
			case *v13.TestResults_Details_Error:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Error))))
				_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(t.Error), len(t.Error)))
			case *v13.TestResults_Details_Success:
				if t.Success != nil {
					cerbos_policy_v1_TestResults_Success_hashpb_sum(t.Success, hasher, ignore, b)
				}
			case *v13.TestResults_Details_SkipReason:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.SkipReason))))
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Details.engine_trace"]; !ok {
		if len(m.EngineTrace) > 0 {
			for _, v := range m.EngineTrace {
				if v != nil {
					cerbos_engine_v1_Trace_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.policy.v1.TestResults.Details.engine_trace_batch"]; !ok {
		if m.GetEngineTraceBatch() != nil {
			cerbos_engine_v1_TraceBatch_hashpb_sum(m.GetEngineTraceBatch(), hasher, ignore, b)
		}
	}
}
...
func cerbos_policy_v1_TestResults_Failure_hashpb_sum(m *v13.TestResults_Failure, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.TestResults.Failure.expected"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetExpected())))
	}
	if _, ok := ignore["cerbos.policy.v1.TestResults.Failure.actual"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetActual())))
	}
	if _, ok := ignore["cerbos.policy.v1.TestResults.Failure.outputs"]; !ok {
		if len(m.Outputs) > 0 {
			for _, v := range m.Outputs {
				if v != nil {
					cerbos_policy_v1_TestResults_OutputFailure_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestResults_OutputFailure_MismatchedValue_hashpb_sum(m *v13.TestResults_OutputFailure_MismatchedValue, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.OutputFailure.MismatchedValue.actual"]; !ok {
		if m.GetActual() != nil {
			google_protobuf_Value_hashpb_sum(m.GetActual(), hasher, ignore, b)
		}
	}
}
...
func cerbos_policy_v1_TestResults_OutputFailure_hashpb_sum(m *v13.TestResults_OutputFailure, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.policy.v1.TestResults.OutputFailure.outcome"]; !ok {
			switch t := m.Outcome.(type) {
			case *v13.TestResults_OutputFailure_Mismatched:
				if t.Mismatched != nil {
					cerbos_policy_v1_TestResults_OutputFailure_MismatchedValue_hashpb_sum(t.Mismatched, hasher, ignore, b)
				}
			case *v13.TestResults_OutputFailure_Missing:
				if t.Missing != nil {
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Principal.resources"]; !ok {
		if len(m.Resources) > 0 {
			for _, v := range m.Resources {
				if v != nil {
					cerbos_policy_v1_TestResults_Resource_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestResults_Resource_hashpb_sum(m *v13.TestResults_Resource, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Resource.actions"]; !ok {
		if len(m.Actions) > 0 {
			for _, v := range m.Actions {
				if v != nil {
					cerbos_policy_v1_TestResults_Action_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestResults_Suite_hashpb_sum(m *v13.TestResults_Suite, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Suite.principals"]; !ok {
		if len(m.Principals) > 0 {
			for _, v := range m.Principals {
				if v != nil {
					cerbos_policy_v1_TestResults_Principal_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.policy.v1.TestResults.Suite.summary"]; !ok {
		if m.GetSummary() != nil {
			cerbos_policy_v1_TestResults_Summary_hashpb_sum(m.GetSummary(), hasher, ignore, b)
		}
	}
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Suite.test_cases"]; !ok {
		if len(m.TestCases) > 0 {
			for _, v := range m.TestCases {
				if v != nil {
					cerbos_policy_v1_TestResults_TestCase_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Suite.skip_reason"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetSkipReason()))))
...
func cerbos_policy_v1_TestResults_Summary_hashpb_sum(m *v13.TestResults_Summary, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.TestResults.Summary.overall_result"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetOverallResult())))
	}
	if _, ok := ignore["cerbos.policy.v1.TestResults.Summary.tests_count"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetTestsCount())))
	}
	if _, ok := ignore["cerbos.policy.v1.TestResults.Summary.result_counts"]; !ok {
		if len(m.ResultCounts) > 0 {
			for _, v := range m.ResultCounts {
				if v != nil {
					cerbos_policy_v1_TestResults_Tally_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestResults_Tally_hashpb_sum(m *v13.TestResults_Tally, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.Tally.count"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetCount())))
	}
}
	...
	if _, ok := ignore["cerbos.policy.v1.TestResults.suites"]; !ok {
		if len(m.Suites) > 0 {
			for _, v := range m.Suites {
				if v != nil {
					cerbos_policy_v1_TestResults_Suite_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestTable_Expectation_hashpb_sum(m *v13.TestTable_Expectation, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestTable.Expectation.outputs"]; !ok {
		if len(m.Outputs) > 0 {
			for _, v := range m.Outputs {
				if v != nil {
					cerbos_policy_v1_TestTable_OutputExpectations_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_policy_v1_TestTable_Input_hashpb_sum(m *v13.TestTable_Input, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestTable.Input.aux_data"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetAuxData()))))
...
func cerbos_policy_v1_TestTable_hashpb_sum(m *v13.TestTable, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.policy.v1.TestTable.skip"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetSkip())))
	}
	...
	if _, ok := ignore["cerbos.policy.v1.TestTable.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_policy_v1_TestTable_Input_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.policy.v1.TestTable.expected"]; !ok {
		if len(m.Expected) > 0 {
			for _, v := range m.Expected {
				if v != nil {
					cerbos_policy_v1_TestTable_Expectation_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.policy.v1.TestTable.options"]; !ok {
		if m.GetOptions() != nil {
			cerbos_policy_v1_TestOptions_hashpb_sum(m.GetOptions(), hasher, ignore, b)
		}
	}
}
		...
		if len(m.Entries) > 0 {
			if len(m.Entries) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Entries[k] != nil {
						google_protobuf_Value_hashpb_sum(m.Entries[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_policy_v1_Test_TestName_hashpb_sum(m *v13.Test_TestName, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.Test.TestName.test_table_name"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetTestTableName()))))
	...
	if _, ok := ignore["cerbos.policy.v1.Test.TestName.principal_key"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetPrincipalKey()))))
	...
	if _, ok := ignore["cerbos.policy.v1.Test.TestName.resource_key"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetResourceKey()))))
...
func cerbos_policy_v1_Test_hashpb_sum(m *v13.Test, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.policy.v1.Test.name"]; !ok {
		if m.GetName() != nil {
			cerbos_policy_v1_Test_TestName_hashpb_sum(m.GetName(), hasher, ignore, b)
		}
	}
	...
	if _, ok := ignore["cerbos.policy.v1.Test.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_engine_v1_CheckInput_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.policy.v1.Test.expected"]; !ok {
		if len(m.Expected) > 0 {
			if len(m.Expected) <= 32 {
				keys := hashpb_stringKeyPool.Get().([]string)[:0]
				...
				for _, k := range keys {
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(k))))
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.Expected[k])))
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
			...
			if len(m.ExpectedOutputs) <= 32 {
				...
				for _, k := range keys {
					...
					if m.ExpectedOutputs[k] != nil {
						cerbos_policy_v1_Test_OutputEntries_hashpb_sum(m.ExpectedOutputs[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
		...
		if len(m.Local) > 0 {
			if len(m.Local) <= 32 {
				...
				for _, k := range keys {
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(k))))
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.Local[k]))))
		...
		if _, ok := ignore["cerbos.private.v1.BlobClonerTestCase.File.operation"]; !ok {
			...
			case *BlobClonerTestCase_File_AddOrUpdate_:
				if t.AddOrUpdate != nil {
					cerbos_private_v1_BlobClonerTestCase_File_AddOrUpdate_hashpb_sum(t.AddOrUpdate, hasher, ignore, b)
				}
			case *BlobClonerTestCase_File_Delete_:
				if t.Delete != nil {
					cerbos_private_v1_BlobClonerTestCase_File_Delete_hashpb_sum(t.Delete, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.BlobClonerTestCase.Step.Differences.files"]; !ok {
		if len(m.Files) > 0 {
			for _, v := range m.Files {
				if v != nil {
					cerbos_private_v1_BlobClonerTestCase_File_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_BlobClonerTestCase_Step_Expectation_Info_hashpb_sum(m *BlobClonerTestCase_Step_Expectation_Info, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.BlobClonerTestCase.Step.Expectation.Info.etag"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetEtag()))))
		...
		if len(m.All) > 0 {
			if len(m.All) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.All[k] != nil {
						cerbos_private_v1_BlobClonerTestCase_Step_Expectation_Files_hashpb_sum(m.All[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
	...
	if _, ok := ignore["cerbos.private.v1.BlobClonerTestCase.Step.Expectation.added_or_updated"]; !ok {
		if len(m.AddedOrUpdated) > 0 {
			for _, v := range m.AddedOrUpdated {
				if v != nil {
					cerbos_private_v1_BlobClonerTestCase_Step_Expectation_Info_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
		...
		if _, ok := ignore["cerbos.private.v1.BlobClonerTestCase.Step.op"]; !ok {
			...
			case *BlobClonerTestCase_Step_Expectation_:
				if t.Expectation != nil {
					cerbos_private_v1_BlobClonerTestCase_Step_Expectation_hashpb_sum(t.Expectation, hasher, ignore, b)
				}
			case *BlobClonerTestCase_Step_Differences_:
				if t.Differences != nil {
					cerbos_private_v1_BlobClonerTestCase_Step_Differences_hashpb_sum(t.Differences, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.BlobClonerTestCase.steps"]; !ok {
		if len(m.Steps) > 0 {
			for _, v := range m.Steps {
				if v != nil {
					cerbos_private_v1_BlobClonerTestCase_Step_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_CelTestCase_hashpb_sum(m *CelTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.CelTestCase.condition"]; !ok {
		if m.GetCondition() != nil {
			cerbos_policy_v1_Match_hashpb_sum(m.GetCondition(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.CelTestCase.request"]; !ok {
		if m.GetRequest() != nil {
			cerbos_engine_v1_Request_hashpb_sum(m.GetRequest(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.CelTestCase.want"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetWant())))
	}
...
func cerbos_private_v1_CompileTestCase_Variables_hashpb_sum(m *CompileTestCase_Variables, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.CompileTestCase.Variables.derived_roles"]; !ok {
		if len(m.DerivedRoles) > 0 {
			for _, v := range m.DerivedRoles {
				if v != nil {
					cerbos_private_v1_CompileTestCase_Variables_DerivedRole_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_CompileTestCase_hashpb_sum(m *CompileTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.CompileTestCase.main_def"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetMainDef()))))
	...
	if _, ok := ignore["cerbos.private.v1.CompileTestCase.want_variables"]; !ok {
		if len(m.WantVariables) > 0 {
			for _, v := range m.WantVariables {
				if v != nil {
					cerbos_private_v1_CompileTestCase_Variables_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_IndexBuilderTestCase_CompilationUnit_hashpb_sum(m *IndexBuilderTestCase_CompilationUnit, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.IndexBuilderTestCase.CompilationUnit.main_fqn"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetMainFqn()))))
...
func cerbos_private_v1_IndexBuilderTestCase_hashpb_sum(m *IndexBuilderTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
		...
		if len(m.Files) > 0 {
			if len(m.Files) <= 32 {
				...
				for _, k := range keys {
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(k))))
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.Files[k]))))
	...
	if _, ok := ignore["cerbos.private.v1.IndexBuilderTestCase.want_err_list"]; !ok {
		if m.GetWantErrList() != nil {
			cerbos_runtime_v1_IndexBuildErrors_hashpb_sum(m.GetWantErrList(), hasher, ignore, b)
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.IndexBuilderTestCase.want_compilation_units"]; !ok {
		if len(m.WantCompilationUnits) > 0 {
			for _, v := range m.WantCompilationUnits {
				if v != nil {
					cerbos_private_v1_IndexBuilderTestCase_CompilationUnit_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
		...
		if len(m.Policies) > 0 {
			if len(m.Policies) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Policies[k] != nil {
						cerbos_response_v1_InspectPoliciesResponse_Result_hashpb_sum(m.Policies[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
			...
			if len(m.PolicySets) <= 32 {
				...
				for _, k := range keys {
					...
					if m.PolicySets[k] != nil {
						cerbos_response_v1_InspectPoliciesResponse_Result_hashpb_sum(m.PolicySets[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
		...
		if _, ok := ignore["cerbos.private.v1.InspectTestCase.PolicySetsExpectation.errors"]; !ok {
			...
			case *InspectTestCase_PolicySetsExpectation_CompileErrors:
				if t.CompileErrors != nil {
					cerbos_private_v1_InspectTestCase_CompileErrors_hashpb_sum(t.CompileErrors, hasher, ignore, b)
				}
			...
			if len(m.RuleTables) <= 32 {
				...
				for _, k := range keys {
					...
					if m.RuleTables[k] != nil {
						cerbos_response_v1_InspectPoliciesResponse_Result_hashpb_sum(m.RuleTables[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_private_v1_InspectTestCase_hashpb_sum(m *InspectTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.InspectTestCase.inputs"]; !ok {
		if len(m.Inputs) > 0 {
			for _, v := range m.Inputs {
				if v != nil {
					cerbos_policy_v1_Policy_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.InspectTestCase.policies_expectation"]; !ok {
		if m.GetPoliciesExpectation() != nil {
			cerbos_private_v1_InspectTestCase_PoliciesExpectation_hashpb_sum(m.GetPoliciesExpectation(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.InspectTestCase.policy_sets_expectation"]; !ok {
		if m.GetPolicySetsExpectation() != nil {
			cerbos_private_v1_InspectTestCase_PolicySetsExpectation_hashpb_sum(m.GetPolicySetsExpectation(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.InspectTestCase.rule_tables_expectation"]; !ok {
		if m.GetRuleTablesExpectation() != nil {
			cerbos_private_v1_InspectTestCase_RuleTablesExpectation_hashpb_sum(m.GetRuleTablesExpectation(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ProtoYamlTestCase_Want_hashpb_sum(m *ProtoYamlTestCase_Want, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ProtoYamlTestCase.Want.message"]; !ok {
		if m.GetMessage() != nil {
			cerbos_policy_v1_Policy_hashpb_sum(m.GetMessage(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ProtoYamlTestCase.Want.errors"]; !ok {
		if len(m.Errors) > 0 {
			for _, v := range m.Errors {
				if v != nil {
					cerbos_source_v1_Error_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.ProtoYamlTestCase.want"]; !ok {
		if len(m.Want) > 0 {
			for _, v := range m.Want {
				if v != nil {
					cerbos_private_v1_ProtoYamlTestCase_Want_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_QueryPlannerFilterTestCase_hashpb_sum(m *QueryPlannerFilterTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.QueryPlannerFilterTestCase.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_engine_v1_PlanResourcesFilter_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.QueryPlannerFilterTestCase.want_filter"]; !ok {
		if m.GetWantFilter() != nil {
			cerbos_engine_v1_PlanResourcesFilter_hashpb_sum(m.GetWantFilter(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.QueryPlannerFilterTestCase.want_string"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetWantString()))))
...
func cerbos_private_v1_SchemaTestCase_hashpb_sum(m *SchemaTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.SchemaTestCase.schema_refs"]; !ok {
		if m.GetSchemaRefs() != nil {
			cerbos_policy_v1_Schemas_hashpb_sum(m.GetSchemaRefs(), hasher, ignore, b)
		}
	}
	if m.Input != nil {
		if _, ok := ignore["cerbos.private.v1.SchemaTestCase.input"]; !ok {
			...
			case *SchemaTestCase_CheckInput:
				if t.CheckInput != nil {
					cerbos_engine_v1_CheckInput_hashpb_sum(t.CheckInput, hasher, ignore, b)
				}
			case *SchemaTestCase_PlanResourcesInput:
				if t.PlanResourcesInput != nil {
					cerbos_engine_v1_PlanResourcesInput_hashpb_sum(t.PlanResourcesInput, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_ServerTestCase_AdminAddOrUpdatePolicyCall_hashpb_sum(m *ServerTestCase_AdminAddOrUpdatePolicyCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.AdminAddOrUpdatePolicyCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_AddOrUpdatePolicyRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.AdminAddOrUpdatePolicyCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_AddOrUpdatePolicyResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_AdminAddOrUpdateSchemaCall_hashpb_sum(m *ServerTestCase_AdminAddOrUpdateSchemaCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.AdminAddOrUpdateSchemaCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_AddOrUpdateSchemaRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.AdminAddOrUpdateSchemaCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_AddOrUpdateSchemaResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_CheckResourceBatchCall_hashpb_sum(m *ServerTestCase_CheckResourceBatchCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.CheckResourceBatchCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_CheckResourceBatchRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.CheckResourceBatchCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_CheckResourceBatchResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_CheckResourceSetCall_hashpb_sum(m *ServerTestCase_CheckResourceSetCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.CheckResourceSetCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_CheckResourceSetRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.CheckResourceSetCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_CheckResourceSetResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_CheckResourcesCall_hashpb_sum(m *ServerTestCase_CheckResourcesCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.CheckResourcesCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_CheckResourcesRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.CheckResourcesCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_CheckResourcesResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_PlanResourcesCall_hashpb_sum(m *ServerTestCase_PlanResourcesCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlanResourcesCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_PlanResourcesRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlanResourcesCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_PlanResourcesResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_PlaygroundEvaluateCall_hashpb_sum(m *ServerTestCase_PlaygroundEvaluateCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundEvaluateCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_PlaygroundEvaluateRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundEvaluateCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_PlaygroundEvaluateResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_PlaygroundProxyCall_hashpb_sum(m *ServerTestCase_PlaygroundProxyCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundProxyCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_PlaygroundProxyRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundProxyCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_PlaygroundProxyResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_PlaygroundTestCall_hashpb_sum(m *ServerTestCase_PlaygroundTestCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundTestCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_PlaygroundTestRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundTestCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_PlaygroundTestResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_PlaygroundValidateCall_hashpb_sum(m *ServerTestCase_PlaygroundValidateCall, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundValidateCall.input"]; !ok {
		if m.GetInput() != nil {
			cerbos_request_v1_PlaygroundValidateRequest_hashpb_sum(m.GetInput(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.PlaygroundValidateCall.want_response"]; !ok {
		if m.GetWantResponse() != nil {
			cerbos_response_v1_PlaygroundValidateResponse_hashpb_sum(m.GetWantResponse(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_ServerTestCase_Status_hashpb_sum(m *ServerTestCase_Status, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.Status.http_status_code"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetHttpStatusCode())))
	}
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.Status.grpc_status_code"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetGrpcStatusCode())))
	}
}
...
func cerbos_private_v1_ServerTestCase_hashpb_sum(m *ServerTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.ServerTestCase.want_status"]; !ok {
		if m.GetWantStatus() != nil {
			cerbos_private_v1_ServerTestCase_Status_hashpb_sum(m.GetWantStatus(), hasher, ignore, b)
		}
	}
	if m.CallKind != nil {
		if _, ok := ignore["cerbos.private.v1.ServerTestCase.call_kind"]; !ok {
			...
			case *ServerTestCase_CheckResourceSet:
				if t.CheckResourceSet != nil {
					cerbos_private_v1_ServerTestCase_CheckResourceSetCall_hashpb_sum(t.CheckResourceSet, hasher, ignore, b)
				}
			case *ServerTestCase_CheckResourceBatch:
				if t.CheckResourceBatch != nil {
					cerbos_private_v1_ServerTestCase_CheckResourceBatchCall_hashpb_sum(t.CheckResourceBatch, hasher, ignore, b)
				}
			case *ServerTestCase_PlaygroundValidate:
				if t.PlaygroundValidate != nil {
					cerbos_private_v1_ServerTestCase_PlaygroundValidateCall_hashpb_sum(t.PlaygroundValidate, hasher, ignore, b)
				}
			case *ServerTestCase_PlaygroundEvaluate:
				if t.PlaygroundEvaluate != nil {
					cerbos_private_v1_ServerTestCase_PlaygroundEvaluateCall_hashpb_sum(t.PlaygroundEvaluate, hasher, ignore, b)
				}
			case *ServerTestCase_AdminAddOrUpdatePolicy:
				if t.AdminAddOrUpdatePolicy != nil {
					cerbos_private_v1_ServerTestCase_AdminAddOrUpdatePolicyCall_hashpb_sum(t.AdminAddOrUpdatePolicy, hasher, ignore, b)
				}
			case *ServerTestCase_PlaygroundProxy:
				if t.PlaygroundProxy != nil {
					cerbos_private_v1_ServerTestCase_PlaygroundProxyCall_hashpb_sum(t.PlaygroundProxy, hasher, ignore, b)
				}
			case *ServerTestCase_PlanResources:
				if t.PlanResources != nil {
					cerbos_private_v1_ServerTestCase_PlanResourcesCall_hashpb_sum(t.PlanResources, hasher, ignore, b)
				}
			case *ServerTestCase_AdminAddOrUpdateSchema:
				if t.AdminAddOrUpdateSchema != nil {
					cerbos_private_v1_ServerTestCase_AdminAddOrUpdateSchemaCall_hashpb_sum(t.AdminAddOrUpdateSchema, hasher, ignore, b)
				}
			case *ServerTestCase_PlaygroundTest:
				if t.PlaygroundTest != nil {
					cerbos_private_v1_ServerTestCase_PlaygroundTestCall_hashpb_sum(t.PlaygroundTest, hasher, ignore, b)
				}
			case *ServerTestCase_CheckResources:
				if t.CheckResources != nil {
					cerbos_private_v1_ServerTestCase_CheckResourcesCall_hashpb_sum(t.CheckResources, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_TestTracesWrapper_hashpb_sum(m *TestTracesWrapper, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.TestTracesWrapper.engine_trace"]; !ok {
		if len(m.EngineTrace) > 0 {
			for _, v := range m.EngineTrace {
				if v != nil {
					cerbos_engine_v1_Trace_hashpb_sum(v, hasher, ignore, b)
...
func cerbos_private_v1_VerifyTestCase_Config_hashpb_sum(m *VerifyTestCase_Config, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.VerifyTestCase.Config.included_test_names_regexp"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetIncludedTestNamesRegexp()))))
...
func cerbos_private_v1_VerifyTestCase_hashpb_sum(m *VerifyTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.VerifyTestCase.config"]; !ok {
		if m.GetConfig() != nil {
			cerbos_private_v1_VerifyTestCase_Config_hashpb_sum(m.GetConfig(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_VerifyTestSuiteRunGetTestsTestCase_hashpb_sum(m *VerifyTestSuiteRunGetTestsTestCase, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.VerifyTestSuiteRunGetTestsTestCase.table"]; !ok {
		if m.GetTable() != nil {
			cerbos_policy_v1_TestTable_hashpb_sum(m.GetTable(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.VerifyTestSuiteRunGetTestsTestCase.want_tests"]; !ok {
		if len(m.WantTests) > 0 {
			for _, v := range m.WantTests {
				if v != nil {
					cerbos_policy_v1_Test_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_private_v1_WellKnownTypes_Nested_hashpb_sum(m *WellKnownTypes_Nested, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.Nested.string_field"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetStringField()))))
	...
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.Nested.value_field"]; !ok {
		if m.GetValueField() != nil {
			google_protobuf_Value_hashpb_sum(m.GetValueField(), hasher, ignore, b)
		}
	}
}
...
func cerbos_private_v1_WellKnownTypes_hashpb_sum(m *WellKnownTypes, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_bool_wrapper"]; !ok {
		if len(m.RepeatedBoolWrapper) > 0 {
			for _, v := range m.RepeatedBoolWrapper {
				if v != nil {
					google_protobuf_BoolValue_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_int32_wrapper"]; !ok {
		if len(m.RepeatedInt32Wrapper) > 0 {
			for _, v := range m.RepeatedInt32Wrapper {
				if v != nil {
					google_protobuf_Int32Value_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_int64_wrapper"]; !ok {
		if len(m.RepeatedInt64Wrapper) > 0 {
			for _, v := range m.RepeatedInt64Wrapper {
				if v != nil {
					google_protobuf_Int64Value_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_uint32_wrapper"]; !ok {
		if len(m.RepeatedUint32Wrapper) > 0 {
			for _, v := range m.RepeatedUint32Wrapper {
				if v != nil {
					google_protobuf_UInt32Value_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_uint64_wrapper"]; !ok {
		if len(m.RepeatedUint64Wrapper) > 0 {
			for _, v := range m.RepeatedUint64Wrapper {
				if v != nil {
					google_protobuf_UInt64Value_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_float_wrapper"]; !ok {
		if len(m.RepeatedFloatWrapper) > 0 {
			for _, v := range m.RepeatedFloatWrapper {
				if v != nil {
					google_protobuf_FloatValue_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_double_wrapper"]; !ok {
		if len(m.RepeatedDoubleWrapper) > 0 {
			for _, v := range m.RepeatedDoubleWrapper {
				if v != nil {
					google_protobuf_DoubleValue_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_string_wrapper"]; !ok {
		if len(m.RepeatedStringWrapper) > 0 {
			for _, v := range m.RepeatedStringWrapper {
				if v != nil {
					google_protobuf_StringValue_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_bytes_wrapper"]; !ok {
		if len(m.RepeatedBytesWrapper) > 0 {
			for _, v := range m.RepeatedBytesWrapper {
				if v != nil {
					google_protobuf_BytesValue_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.struct"]; !ok {
		if m.GetStruct() != nil {
			google_protobuf_Struct_hashpb_sum(m.GetStruct(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.any"]; !ok {
		if m.GetAny() != nil {
			google_protobuf_Any_hashpb_sum(m.GetAny(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.value"]; !ok {
		if m.GetValue() != nil {
			google_protobuf_Value_hashpb_sum(m.GetValue(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.null_value"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetNullValue())))
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_duration"]; !ok {
		if len(m.RepeatedDuration) > 0 {
			for _, v := range m.RepeatedDuration {
				if v != nil {
					google_protobuf_Duration_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_struct"]; !ok {
		if len(m.RepeatedStruct) > 0 {
			for _, v := range m.RepeatedStruct {
				if v != nil {
					google_protobuf_Struct_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_any"]; !ok {
		if len(m.RepeatedAny) > 0 {
			for _, v := range m.RepeatedAny {
				if v != nil {
					google_protobuf_Any_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	...
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.repeated_list_value"]; !ok {
		if len(m.RepeatedListValue) > 0 {
			for _, v := range m.RepeatedListValue {
				if v != nil {
					google_protobuf_ListValue_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.private.v1.WellKnownTypes.optional_nested_msg"]; !ok {
		if m.GetOptionalNestedMsg() != nil {
			cerbos_private_v1_WellKnownTypes_Nested_hashpb_sum(m.GetOptionalNestedMsg(), hasher, ignore, b)
		}
	}
}
	...
	if _, ok := ignore["cerbos.request.v1.AddOrUpdateSchemaRequest.schemas"]; !ok {
		if len(m.Schemas) > 0 {
			for _, v := range m.Schemas {
				if v != nil {
					cerbos_schema_v1_Schema_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_request_v1_AuxData_JWT_hashpb_sum(m *v14.AuxData_JWT, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.request.v1.AuxData.JWT.key_set_id"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetKeySetId()))))
...
func cerbos_request_v1_CheckResourceBatchRequest_hashpb_sum(m *v14.CheckResourceBatchRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.request.v1.CheckResourceBatchRequest.resources"]; !ok {
		if len(m.Resources) > 0 {
			for _, v := range m.Resources {
				if v != nil {
					cerbos_request_v1_CheckResourceBatchRequest_BatchEntry_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.request.v1.CheckResourceBatchRequest.aux_data"]; !ok {
		if m.GetAuxData() != nil {
			cerbos_request_v1_AuxData_hashpb_sum(m.GetAuxData(), hasher, ignore, b)
		}
	}
}
...
func cerbos_request_v1_CheckResourceSetRequest_hashpb_sum(m *v14.CheckResourceSetRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.request.v1.CheckResourceSetRequest.resource"]; !ok {
		if m.GetResource() != nil {
			cerbos_request_v1_ResourceSet_hashpb_sum(m.GetResource(), hasher, ignore, b)
		}
	}
...
func cerbos_request_v1_CheckResourcesRequest_hashpb_sum(m *v14.CheckResourcesRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.request.v1.CheckResourcesRequest.resources"]; !ok {
		if len(m.Resources) > 0 {
			for _, v := range m.Resources {
				if v != nil {
					cerbos_request_v1_CheckResourcesRequest_ResourceEntry_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_request_v1_File_hashpb_sum(m *v14.File, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.request.v1.File.file_name"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetFileName()))))
...
func cerbos_request_v1_PlaygroundEvaluateRequest_hashpb_sum(m *v14.PlaygroundEvaluateRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.request.v1.PlaygroundEvaluateRequest.playground_id"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetPlaygroundId()))))
	...
	if _, ok := ignore["cerbos.request.v1.PlaygroundEvaluateRequest.files"]; !ok {
		if len(m.Files) > 0 {
			for _, v := range m.Files {
				if v != nil {
					cerbos_request_v1_File_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_request_v1_PlaygroundProxyRequest_hashpb_sum(m *v14.PlaygroundProxyRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.ProxyRequest != nil {
		if _, ok := ignore["cerbos.request.v1.PlaygroundProxyRequest.proxy_request"]; !ok {
			...
			case *v14.PlaygroundProxyRequest_CheckResourceSet:
				if t.CheckResourceSet != nil {
					cerbos_request_v1_CheckResourceSetRequest_hashpb_sum(t.CheckResourceSet, hasher, ignore, b)
				}
			case *v14.PlaygroundProxyRequest_CheckResourceBatch:
				if t.CheckResourceBatch != nil {
					cerbos_request_v1_CheckResourceBatchRequest_hashpb_sum(t.CheckResourceBatch, hasher, ignore, b)
				}
			case *v14.PlaygroundProxyRequest_PlanResources:
				if t.PlanResources != nil {
					cerbos_request_v1_PlanResourcesRequest_hashpb_sum(t.PlanResources, hasher, ignore, b)
				}
			case *v14.PlaygroundProxyRequest_CheckResources:
				if t.CheckResources != nil {
					cerbos_request_v1_CheckResourcesRequest_hashpb_sum(t.CheckResources, hasher, ignore, b)
				}
			case *v14.PlaygroundProxyRequest_AccessEvaluation:
				if t.AccessEvaluation != nil {
					authzen_authorization_v1_AccessEvaluationRequest_hashpb_sum(t.AccessEvaluation, hasher, ignore, b)
				}
			case *v14.PlaygroundProxyRequest_AccessEvaluationBatch:
				if t.AccessEvaluationBatch != nil {
					authzen_authorization_v1_AccessEvaluationBatchRequest_hashpb_sum(t.AccessEvaluationBatch, hasher, ignore, b)
				}
			}
		}
	}
			...
			if len(m.Instances) <= 32 {
				...
				for _, k := range keys {
					...
					if m.Instances[k] != nil {
						cerbos_request_v1_AttributesMap_hashpb_sum(m.Instances[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_response_v1_AddOrUpdatePolicyResponse_hashpb_sum(m *v15.AddOrUpdatePolicyResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.AddOrUpdatePolicyResponse.success"]; !ok {
		if m.GetSuccess() != nil {
			google_protobuf_Empty_hashpb_sum(m.GetSuccess(), hasher, ignore, b)
		}
	}
}
	...
	if _, ok := ignore["cerbos.response.v1.CheckResourceBatchResponse.results"]; !ok {
		if len(m.Results) > 0 {
			for _, v := range m.Results {
				if v != nil {
					cerbos_response_v1_CheckResourceBatchResponse_ActionEffectMap_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
		...
		if len(m.Actions) > 0 {
			if len(m.Actions) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Actions[k] != nil {
						cerbos_response_v1_CheckResourceSetResponse_Meta_EffectMeta_hashpb_sum(m.Actions[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
			...
			if len(m.ResourceInstances) <= 32 {
				...
				for _, k := range keys {
					...
					if m.ResourceInstances[k] != nil {
						cerbos_response_v1_CheckResourceSetResponse_Meta_ActionMeta_hashpb_sum(m.ResourceInstances[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_response_v1_CheckResourceSetResponse_hashpb_sum(m *v15.CheckResourceSetResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
		...
		if len(m.ResourceInstances) > 0 {
			if len(m.ResourceInstances) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.ResourceInstances[k] != nil {
						cerbos_response_v1_CheckResourceSetResponse_ActionEffectMap_hashpb_sum(m.ResourceInstances[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
	...
	if _, ok := ignore["cerbos.response.v1.CheckResourceSetResponse.meta"]; !ok {
		if m.GetMeta() != nil {
			cerbos_response_v1_CheckResourceSetResponse_Meta_hashpb_sum(m.GetMeta(), hasher, ignore, b)
		}
	}
}
...
func cerbos_response_v1_InspectPoliciesResponse_Constant_hashpb_sum(m *v15.InspectPoliciesResponse_Constant, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.response.v1.InspectPoliciesResponse.Constant.used"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetUsed())))
	}
}
...
func cerbos_response_v1_InspectPoliciesResponse_Result_hashpb_sum(m *v15.InspectPoliciesResponse_Result, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.response.v1.InspectPoliciesResponse.Result.variables"]; !ok {
		if len(m.Variables) > 0 {
			for _, v := range m.Variables {
				if v != nil {
					cerbos_response_v1_InspectPoliciesResponse_Variable_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.response.v1.InspectPoliciesResponse.Result.policy_id"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetPolicyId()))))
	...
	if _, ok := ignore["cerbos.response.v1.InspectPoliciesResponse.Result.derived_roles"]; !ok {
		if len(m.DerivedRoles) > 0 {
			for _, v := range m.DerivedRoles {
				if v != nil {
					cerbos_response_v1_InspectPoliciesResponse_DerivedRole_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.response.v1.InspectPoliciesResponse.Result.attributes"]; !ok {
		if len(m.Attributes) > 0 {
			for _, v := range m.Attributes {
				if v != nil {
					cerbos_response_v1_InspectPoliciesResponse_Attribute_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.response.v1.InspectPoliciesResponse.Result.constants"]; !ok {
		if len(m.Constants) > 0 {
			for _, v := range m.Constants {
				if v != nil {
					cerbos_response_v1_InspectPoliciesResponse_Constant_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_response_v1_PlaygroundEvaluateResponse_EvalResultList_hashpb_sum(m *v15.PlaygroundEvaluateResponse_EvalResultList, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.PlaygroundEvaluateResponse.EvalResultList.results"]; !ok {
		if len(m.Results) > 0 {
			for _, v := range m.Results {
				if v != nil {
					cerbos_response_v1_PlaygroundEvaluateResponse_EvalResult_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_response_v1_PlaygroundEvaluateResponse_hashpb_sum(m *v15.PlaygroundEvaluateResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.response.v1.PlaygroundEvaluateResponse.outcome"]; !ok {
			switch t := m.Outcome.(type) {
			case *v15.PlaygroundEvaluateResponse_Failure:
				if t.Failure != nil {
					cerbos_response_v1_PlaygroundFailure_hashpb_sum(t.Failure, hasher, ignore, b)
				}
			case *v15.PlaygroundEvaluateResponse_Success:
				if t.Success != nil {
					cerbos_response_v1_PlaygroundEvaluateResponse_EvalResultList_hashpb_sum(t.Success, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_response_v1_PlaygroundFailure_Error_hashpb_sum(m *v15.PlaygroundFailure_Error, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.response.v1.PlaygroundFailure.Error.details"]; !ok {
		if m.GetDetails() != nil {
			cerbos_response_v1_PlaygroundFailure_ErrorDetails_hashpb_sum(m.GetDetails(), hasher, ignore, b)
		}
	}
}
...
func cerbos_response_v1_PlaygroundFailure_hashpb_sum(m *v15.PlaygroundFailure, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.PlaygroundFailure.errors"]; !ok {
		if len(m.Errors) > 0 {
			for _, v := range m.Errors {
				if v != nil {
					cerbos_response_v1_PlaygroundFailure_Error_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_response_v1_PlaygroundProxyResponse_hashpb_sum(m *v15.PlaygroundProxyResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.response.v1.PlaygroundProxyResponse.outcome"]; !ok {
			switch t := m.Outcome.(type) {
			case *v15.PlaygroundProxyResponse_Failure:
				if t.Failure != nil {
					cerbos_response_v1_PlaygroundFailure_hashpb_sum(t.Failure, hasher, ignore, b)
				}
			case *v15.PlaygroundProxyResponse_CheckResourceSet:
				if t.CheckResourceSet != nil {
					cerbos_response_v1_CheckResourceSetResponse_hashpb_sum(t.CheckResourceSet, hasher, ignore, b)
				}
			case *v15.PlaygroundProxyResponse_CheckResourceBatch:
				if t.CheckResourceBatch != nil {
					cerbos_response_v1_CheckResourceBatchResponse_hashpb_sum(t.CheckResourceBatch, hasher, ignore, b)
				}
			case *v15.PlaygroundProxyResponse_PlanResources:
				if t.PlanResources != nil {
					cerbos_response_v1_PlanResourcesResponse_hashpb_sum(t.PlanResources, hasher, ignore, b)
				}
			case *v15.PlaygroundProxyResponse_CheckResources:
				if t.CheckResources != nil {
					cerbos_response_v1_CheckResourcesResponse_hashpb_sum(t.CheckResources, hasher, ignore, b)
				}
			case *v15.PlaygroundProxyResponse_AccessEvaluation:
				if t.AccessEvaluation != nil {
					authzen_authorization_v1_AccessEvaluationResponse_hashpb_sum(t.AccessEvaluation, hasher, ignore, b)
				}
			case *v15.PlaygroundProxyResponse_AccessEvaluationBatch:
				if t.AccessEvaluationBatch != nil {
					authzen_authorization_v1_AccessEvaluationBatchResponse_hashpb_sum(t.AccessEvaluationBatch, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_response_v1_PlaygroundTestResponse_TestResults_hashpb_sum(m *v15.PlaygroundTestResponse_TestResults, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.PlaygroundTestResponse.TestResults.results"]; !ok {
		if m.GetResults() != nil {
			cerbos_policy_v1_TestResults_hashpb_sum(m.GetResults(), hasher, ignore, b)
		}
	}
}
...
func cerbos_response_v1_PlaygroundTestResponse_hashpb_sum(m *v15.PlaygroundTestResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.response.v1.PlaygroundTestResponse.outcome"]; !ok {
			switch t := m.Outcome.(type) {
			case *v15.PlaygroundTestResponse_Failure:
				if t.Failure != nil {
					cerbos_response_v1_PlaygroundFailure_hashpb_sum(t.Failure, hasher, ignore, b)
				}
			case *v15.PlaygroundTestResponse_Success:
				if t.Success != nil {
					cerbos_response_v1_PlaygroundTestResponse_TestResults_hashpb_sum(t.Success, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_response_v1_PlaygroundValidateResponse_hashpb_sum(m *v15.PlaygroundValidateResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Outcome != nil {
		if _, ok := ignore["cerbos.response.v1.PlaygroundValidateResponse.outcome"]; !ok {
			switch t := m.Outcome.(type) {
			case *v15.PlaygroundValidateResponse_Failure:
				if t.Failure != nil {
					cerbos_response_v1_PlaygroundFailure_hashpb_sum(t.Failure, hasher, ignore, b)
				}
			case *v15.PlaygroundValidateResponse_Success:
				if t.Success != nil {
