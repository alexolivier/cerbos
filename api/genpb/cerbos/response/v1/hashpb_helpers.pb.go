...
func cerbos_audit_v1_AccessLogEntry_hashpb_sum(m *v11.AccessLogEntry, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
		...
		if len(m.Errors) > 0 {
			if len(m.Errors) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Errors[k] != nil {
						cerbos_response_v1_IntegrityErrors_hashpb_sum(m.Errors[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
...
func cerbos_response_v1_DeletePolicyResponse_hashpb_sum(m *DeletePolicyResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.DeletePolicyResponse.deleted_policies"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetDeletedPolicies())))
	}
}
...
func cerbos_response_v1_DeleteSchemaResponse_hashpb_sum(m *DeleteSchemaResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.DeleteSchemaResponse.deleted_schemas"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetDeletedSchemas())))
	}
}
...
func cerbos_response_v1_DisablePolicyResponse_hashpb_sum(m *DisablePolicyResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.DisablePolicyResponse.disabled_policies"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetDisabledPolicies())))
	}
}
...
func cerbos_response_v1_EnablePolicyResponse_hashpb_sum(m *EnablePolicyResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.EnablePolicyResponse.enabled_policies"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetEnabledPolicies())))
	}
}
		...
		if len(m.Results) > 0 {
			if len(m.Results) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Results[k] != nil {
						cerbos_response_v1_InspectPoliciesResponse_Result_hashpb_sum(m.Results[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
				for _, k := range slices.Sorted(maps.Keys(m.Results)) {
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(k))))
					_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(k), len(k)))
					if m.Results[k] != nil {
						cerbos_response_v1_InspectPoliciesResponse_Result_hashpb_sum(m.Results[k], hasher, ignore, b)
...
func cerbos_response_v1_IntegrityErrors_BreaksScopeChain_hashpb_sum(m *IntegrityErrors_BreaksScopeChain, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.IntegrityErrors.BreaksScopeChain.descendants"]; !ok {
...
func cerbos_response_v1_IntegrityErrors_RequiredByOtherPolicies_hashpb_sum(m *IntegrityErrors_RequiredByOtherPolicies, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.IntegrityErrors.RequiredByOtherPolicies.dependents"]; !ok {
...
func cerbos_response_v1_IntegrityErrors_hashpb_sum(m *IntegrityErrors, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.IntegrityErrors.breaks_scope_chain"]; !ok {
		if m.GetBreaksScopeChain() != nil {
			cerbos_response_v1_IntegrityErrors_BreaksScopeChain_hashpb_sum(m.GetBreaksScopeChain(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.response.v1.IntegrityErrors.required_by_other_policies"]; !ok {
		if m.GetRequiredByOtherPolicies() != nil {
			cerbos_response_v1_IntegrityErrors_RequiredByOtherPolicies_hashpb_sum(m.GetRequiredByOtherPolicies(), hasher, ignore, b)
		}
	}
}
...
func cerbos_response_v1_PurgeStoreRevisionsResponse_hashpb_sum(m *PurgeStoreRevisionsResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.response.v1.PurgeStoreRevisionsResponse.affected_rows"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetAffectedRows())))
	}
}
...
func cerbos_response_v1_ServerInfoResponse_hashpb_sum(m *ServerInfoResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.response.v1.ServerInfoResponse.commit"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetCommit()))))
		_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(m.GetCommit()), len(m.GetCommit())))
	}
	if _, ok := ignore["cerbos.response.v1.ServerInfoResponse.build_date"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetBuildDate()))))
		_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(m.GetBuildDate()), len(m.GetBuildDate())))
	}
}

func cerbos_schema_v1_Schema_hashpb_sum(m *v14.Schema, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
