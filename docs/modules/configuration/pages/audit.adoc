...
[NOTE]
====
Cerbos Hub aggregates decision logs from connected PDPs into a single searchable store, with sensitive fields filtered locally before transmission. See https://docs.cerbos.dev/cerbos-hub/audit-log-collection[Audit log collection].
====
