...
[TIP]
====
For a review of production deployment patterns, scaling characteristics, or operational practices, https://www.cerbos.dev/workshop?utm_campaign=brand_cerbos&utm_source=documentation&utm_medium=text[speak to a Cerbos engineer]. Cerbos Hub provides managed bundle distribution, decision-log aggregation, and PDP monitoring; see https://docs.cerbos.dev/cerbos-hub/[the Cerbos Hub documentation].
====
