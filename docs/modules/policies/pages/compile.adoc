...
[NOTE]
====
Cerbos Hub provides browser-based playgrounds for authoring and testing policies, including execution traces for debugging condition logic. See https://docs.cerbos.dev/cerbos-hub/[the Cerbos Hub documentation].
====
